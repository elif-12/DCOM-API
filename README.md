...
.NET 10 ile geliştirilmiş, Clean Architecture yaklaşımıyla katmanlı yapıda ve xUnit + Moq ile birim testleri yazılmış, tıbbi görüntü (DICOM) dosyalarını yöneten kurumsal bir Web API projesidir.
